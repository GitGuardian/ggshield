...
@pytest.mark.parametrize(
    "vault_path,vault_path_count,expected_fields",
    [
        (None, None, {}),
        (
            "vault_name:/path/to/secret",
            1,
            {"vault_path": "vault_name:/path/to/secret", "vault_path_count": 1},
        ),
        (
            "vault_name:/path/to/secret",
            4,
            {"vault_path": "vault_name:/path/to/secret", "vault_path_count": 4},
        ),
        (
            "vault_name:/path/to/secret",
            None,
            {"vault_path": "vault_name:/path/to/secret"},
        ),
    ],
)
def test_vault_path_in_json_output(
    ...
    WHEN it is passed to the json output handler
    THEN the vault_path and vault_path_count fields are included as expected
    """
    ...
    # Check that fields are not present when vault_path is None
