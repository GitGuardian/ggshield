...
- On Cursor, a secret in an MCP tool's response is now withheld from the
  assistant. Cursor cannot replace a shell command's output or a file's
  content, so those still report the secret as leaked.
